...
description: 展示使用 Expressive Code 时，代码块的显示效果。
tags: [Markdown, Blogging, Demo]
category: Examples
draft: true
---

在这里，我们将探索使用 [Expressive Code](https://expressive-code.com/) 时代码块的外观。以下示例基于官方文档，你可以参考文档获取更多细节。
...
[可折叠代码块](https://expressive-code.com/plugins/collapsible-sections/)
